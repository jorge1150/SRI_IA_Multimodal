...
**Verificado en vivo**: corrida real (`--models qwen2.5:3b-instruct-q4_K_M,gemma4:31b-cloud --modes vector_only --limit 5`, juez `gemma4:31b-cloud` elegido automáticamente) confirma la hipótesis — Faithfulness pasó de 0/N en absolutamente todas las corridas históricas a **5/5** en ambos modelos evaluados. Answer Relevancy también mejoró (4/5 y 5/5, contra fracciones bajas antes). No era una limitación inherente de la técnica, era el juez.
